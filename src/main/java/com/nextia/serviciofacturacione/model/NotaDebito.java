...
/**
 * Representa una nota de débito electrónica según el estándar UBL 2.1 de SUNAT
 */
public class NotaDebito {
    ...
    public NotaDebito(String serie, String correlativo, String fechaEmision) {
        this.serie = serie;
    ...
    /**
     * Obtiene el motivo de la nota de débito
